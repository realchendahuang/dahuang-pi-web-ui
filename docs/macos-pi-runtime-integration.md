...
> 状态：**bundled Runtime 的本机实现、App 启动、manifest 校验、Unix-socket smoke 与 Runtime-owned workspace 文本创建/编辑/移动/删除、受限图片预览、Thread Git checkpoint/review 已完成；消息附件预览、后台/登录生命周期、Keychain 迁移和远程能力仍在实施。**
>
