...
export type WorkspaceTerminalCommandInput = Omit<
	RunTerminalCommandInput,
	"workspace"
>;
...
export interface WorkspacePanelTerminal {
	...
	runCommand(
		input: WorkspaceTerminalCommandInput,
...
export interface WorkspacePanelContext extends WorkspaceContext {
	...
	) => { batchId: string; done: Promise<void> } | undefined;
...
export interface WorkspacePanelContribution {
	...
	) => string | number | TemplateResult | undefined;
	render: (context: WorkspacePanelContext) => TemplateResult;
}

export interface QualifiedWorkspacePanelContribution
	extends WorkspacePanelContribution {
...
export type WorkspaceLabelItem =
	| WorkspaceLabelTextItem
	| WorkspaceLabelLinkItem
	| WorkspaceLabelRenderItem;
...
export interface QualifiedThemePairContribution
	extends Omit<ThemePairContribution, "id" | "light" | "dark"> {
	id: QualifiedContributionId;
	pluginId: PluginId;
	localId: LocalContributionId;
...
export interface QualifiedWorkspaceLabelContribution
	extends WorkspaceLabelContribution {
	id: QualifiedContributionId;
	pluginId: PluginId;
	localId: LocalContributionId;
	machineId?: string;
